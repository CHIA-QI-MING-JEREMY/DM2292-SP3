...
public:
	...
	unsigned int iWindowPosX = 400;
	unsigned int iWindowPosY = 300;
	...
	float ENEMY_NUM_STEPS_PER_TILE_XAXIS;
	float ENEMY_NUM_STEPS_PER_TILE_YAXIS;
	float ENEMY_MICRO_STEP_XAXIS;
	float ENEMY_MICRO_STEP_YAXIS;
