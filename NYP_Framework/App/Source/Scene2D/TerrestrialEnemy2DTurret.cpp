...
bool TEnemy2DTurret::Init(void)
{
	...
	if (cMap2D->FindValue(1802, uiRow, uiCol) == false)
	...
	iTextureID = CImageLoader::GetInstance()->LoadTextureGetID("Image/TerrestrialPlanet/TurretSpriteSheet.png", true);
	if (iTextureID == 0)
	{
		cout << "Unable to load Image/TerrestrialPlanet/TurretSpriteSheet.png" << endl;
		return false;
	}
...
*/
void TEnemy2DTurret::Setvec2Index(const int iIndex_XAxis, const int iIndex_YAxis)
{
...
*/
void TEnemy2DTurret::Setvec2NumMicroSteps(const int iNumMicroSteps_XAxis, const int iNumMicroSteps_YAxis)
{
