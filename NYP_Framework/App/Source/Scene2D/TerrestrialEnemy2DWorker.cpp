...
*/
void TEnemy2DWorker::Setvec2Index(const int iIndex_XAxis, const int iIndex_YAxis)
{
...
*/
void TEnemy2DWorker::Setvec2NumMicroSteps(const int iNumMicroSteps_XAxis, const int iNumMicroSteps_YAxis)
{
